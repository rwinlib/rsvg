...
/* VOID:VOID (../../gdk-pixbuf-2.35.1/gdk-pixbuf/gdk-pixbuf-marshal.list:25) */
#define _gdk_pixbuf_marshal_VOID__VOID	g_cclosure_marshal_VOID__VOID

/* VOID:INT,INT (../../gdk-pixbuf-2.35.1/gdk-pixbuf/gdk-pixbuf-marshal.list:26) */
...
/* VOID:INT,INT,INT,INT (../../gdk-pixbuf-2.35.1/gdk-pixbuf/gdk-pixbuf-marshal.list:27) */
...
/* VOID:POINTER (../../gdk-pixbuf-2.35.1/gdk-pixbuf/gdk-pixbuf-marshal.list:28) */
